...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "Should show user" do #failing
  ...
  test "should not update user when invalid params are sent" do
    patch api_v1_user_url(@user), params: { user: { email: 'bad_email', password: '123456' } }, headers: {Authorization: JsonWebToken.encode(user_id: @user.id)}, as: :json
